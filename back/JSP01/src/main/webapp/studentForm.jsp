...
<html>
	...
	<body>
		<h3>학생 정보 등록</h3>
		<form name="frmStudent" method="post"  action="16_beanStudentOk.jsp">
		 <table>
	       ...
	       <tr><td>관심분야</td>
	       			<td><input type="checkbox" name="stdInterest" value="빅데이터">빅데이터
	       				<input type="checkbox" name="stdInterest" value="인공지능">인공지능
	       				<input type="checkbox" name="stdInterest" value="java">java
	       				<input type="checkbox" name="stdInterest" value="python">파이썬</td></tr>
