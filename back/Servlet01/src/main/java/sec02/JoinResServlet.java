...
public class JoinResServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		System.out.println("loginRes init");
	}

	public void destroy() {
		System.out.println("loginRes destroy");
	}

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("loginRes doGet");
		doProcess(request,response);
	}

	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("loginRes doPost");
		doProcess(request,response);
	}
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html><head><h2>회원 가입 내용</h2></head><body>");
		out.print("성명: "+ user_name+"<br>");
		out.print("ID: "+ user_id+"<br>");
		out.print("비밀번호: "+ user_pw+"<br>");
		out.print("휴대폰 번호: "+first_num+"-"+midle_num+"-"+last_num+"<br>");
		out.print("학년: "+ grade+"<br>");
		out.print("선택한 관심분야: ");
		for(String s:subject) {
			out.print(s+" ");
		}
		out.print("<br>학과 "+stack+"<br>");
		out.print("</body></html>");
